...
<section>
       <div class="row">
           ...
           <div class="col-md-4 individualdetails">
              ...
              <b><div class="row p">Product Name:<p >{{$posts->productsname}}
</b></p></div>
<b><div class="row p">Product Description:<p>{{$posts->productsdescription}}
</b></p></div>
<b><div class="row p">Product Price:<p>{{$posts->productsleastprice}}</b></p></div>
...
<p class="p">
    ...
    <form>
    <a href="cart" ><button type="submit" class="btn  btn-success btn-block load">Load More For This Category</button></a>
    </form>
    </section>
    </div>
@endsection
